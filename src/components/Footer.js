...
function Footer({}) {
    return (
        ...
        <div>
            ...
            <p style={{fontSize:30, textAlign:'left', color:'#717274', fontWeight:'bold'}}>Get Certified Todays</p>
          
                    <p style={{width:'80%', fontWeight:'bold', color:"#717274", textAlign:'left'}}>
        
                     Marine Armor is a new technology to protect endangered and threatened marine mammals from vessel strikes.
                    </p>
